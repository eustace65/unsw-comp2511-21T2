...
public class Task1ExampleTests {
    ...
    public void test2() {
        String initialWorldState = new ResponseHelper(LocalTime.of(0, 0))
            .expectSatellite("SpaceXSatellite", "Satellite2", 10000, 340, 55.5,
                     new String[] { "DeviceA", "DeviceC" })
            .expectDevice("HandheldDevice", "DeviceA", 30)
            .expectDevice("HandheldDevice", "DeviceB", 180)
            .expectDevice("HandheldDevice", "DeviceC", 330)
            .toString();

        TestHelper plan = new TestHelper().createDevice("HandheldDevice", "DeviceA", 30)
            .createDevice("HandheldDevice", "DeviceB", 180)
            .createDevice("HandheldDevice", "DeviceC", 330)
            .createSatellite("SpaceXSatellite", "Satellite2", 10000, 340)
            .showWorldState(initialWorldState);

        String afterMoveWorldState = new ResponseHelper(LocalTime.of(0, 0))
            .expectSatellite("SpaceXSatellite", "Satellite2", 10000, 340, 55.5, new String[] { "DeviceC" })
            .expectDevice("HandheldDevice", "DeviceA", 211) // position has changed
            .expectDevice("HandheldDevice", "DeviceB", 180)
            .expectDevice("HandheldDevice", "DeviceC", 330)
            .toString();
